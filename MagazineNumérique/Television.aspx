<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="Television.aspx.vb" Inherits="Television" %>
    ...
    <div class=""  id="content" role="main">
        <div class="panel panel-default center-block-article col-md-10 col-xs-10">
            <div id="titreRedacteur" class="panel panel-heading">
                <h4 class="text-center title-tele-obs">Télévision</h4>
            </div>
            <div id="teleContent" class="col-md-12 articles-container">
                
            </div>
        </div>
        <script type="text/javascript" src="Ressources/js/articles.js"></script>
        <script type="text/javascript" src="Ressources/js/tele.js"></script>
    </div>
</asp:Content>
